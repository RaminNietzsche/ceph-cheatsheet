  ...
  <div class="hub-hero__grid">
    <div>
      ...
      <h1 class="hub-hero__title">
        自信<span class="hub-gradient">运维</span> Ceph
      </h1>
      <p class="hub-hero__lead">
        CLI 命令、配置项与角色/规模指南，用于日常集群管理。
      </p>
    ...
    <div class="hub-hero__visual">
      ...
      <div class="hub-terminal-wrap">
        ...
        <div class="hub-terminal__metrics">
          <div><div class="hub-terminal__metric-val">CLI</div><div class="hub-terminal__metric-label">9 个主题</div></div>
          <div><div class="hub-terminal__metric-val">CFG</div><div class="hub-terminal__metric-label">13 个索引</div></div>
          <div><div class="hub-terminal__metric-val">3</div><div class="hub-terminal__metric-label">语言</div></div>
        </div>
...
<section class="hub-section" id="guides">
  ...
  <div class="hub-cards">
    <div class="hub-card">
      ...
      <h3 class="hub-card__title">按角色</h3>
      <p class="hub-card__text">集群管理员、存储运维、RGW 管理员、CephFS 管理员。</p>
      <a href="guides/OVERVIEW/#by-role" class="hub-card__link">角色指南 <i class="fas fa-arrow-right"></i></a>
    </div>
    <div class="hub-card">
      <div class="hub-card__icon">📐</div>
      <h3 class="hub-card__title">按规模</h3>
      <p class="hub-card__text">实验室、小型生产、大型生产、多站点。</p>
      <a href="guides/OVERVIEW/#by-scale" class="hub-card__link">规模指南 <i class="fas fa-arrow-right"></i></a>
    </div>
    <div class="hub-card">
      <div class="hub-card__icon">⚡</div>
      <h3 class="hub-card__title">日常运维</h3>
      <p class="hub-card__text">快速入门、故障排查、配置查找、术语表。</p>
      <a href="guides/quickstart/" class="hub-card__link">快速入门 <i class="fas fa-arrow-right"></i></a>
    </div>
  </div>
</section>
    ...
    <div class="hub-split">
      <div>
        ...
        <p class="hub-section__subtitle" style="margin: 1rem 0 0; text-align: inherit;">
          ceph、osd、mon、rgw、rbd、cephfs、cephadm — 可复制命令与示例。
        </p>
        <ul class="hub-list">
          <li><span class="hub-list__arrow">→</span><div><strong>集群与健康</strong><p>状态、认证、CRUSH、编排器</p></div></li>
          <li><span class="hub-list__arrow">→</span><div><strong>RGW / S3</strong><p>用户、桶、多站点、配额</p></div></li>
          <li><span class="hub-list__arrow">→</span><div><strong>存储</strong><p>OSD、池、RBD、RADOS、CephFS</p></div></li>
        </ul>
...
<section class="hub-section" id="config">
  <div class="hub-section__head">
    ...
    <p class="hub-section__subtitle">由 upstream YAML 生成 — global、osd、mon、mgr、mds、rgw、rbd 等</p>
  </div>
  <div class="hub-cards hub-cards--four">
    <div class="hub-card hub-card--compact">
      <h3 class="hub-card__title">global</h3>
      <a href="config/global/INDEX/" class="hub-card__link">852 项 <i class="fas fa-arrow-right"></i></a>
    </div>
    <div class="hub-card hub-card--compact">
      <h3 class="hub-card__title">rgw</h3>
      <a href="config/rgw/INDEX/" class="hub-card__link">441 项 <i class="fas fa-arrow-right"></i></a>
    </div>
    <div class="hub-card hub-card--compact">
      <h3 class="hub-card__title">osd</h3>
      <a href="config/osd/INDEX/" class="hub-card__link">158 项 <i class="fas fa-arrow-right"></i></a>
    </div>
    <div class="hub-card hub-card--compact">
      <h3 class="hub-card__title">全部子系统</h3>
      <a href="config/OVERVIEW/" class="hub-card__link">完整索引 <i class="fas fa-arrow-right"></i></a>
    </div>
  </div>
</section>
...
<footer class="hub-footer hub-footer--section">
  <div class="hub-footer__inner">
    <div>
      <div class="hub-footer__brand"><span>📋</span> 速查表</div>
      <p class="hub-footer__note">独立运维参考 · <a href="/zh/">Ceph Docs Hub</a></p>
    </div>
    <div class="hub-footer__meta">
      <p><a href="../version/">版本</a> · <a href="guides/contributing/">贡献</a></p>
    </div>
  </div>
</footer>
