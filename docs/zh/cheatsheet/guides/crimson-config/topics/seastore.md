...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [seastore_block_create](#seastore_block_create) | `True` | Dev | 开发 |
| [seastore_cachepin_2q_in_ratio](#seastore_cachepin_2q_in_ratio) | `0.5` | Advanced | 性能 |
| [seastore_cachepin_2q_out_ratio](#seastore_cachepin_2q_out_ratio) | `0.5` | Advanced | 性能 |
| [seastore_cachepin_size_pershard](#seastore_cachepin_size_pershard) | `2_G` | Advanced | 性能 |
| [seastore_cachepin_type](#seastore_cachepin_type) | `LRU` | Dev | 开发 |
| [seastore_cbjournal_size](#seastore_cbjournal_size) | `5_G` | Dev | 开发 |
| [seastore_cold_tier_generations](#seastore_cold_tier_generations) | `3` | Advanced | 性能 |
| [seastore_data_delta_based_overwrite](#seastore_data_delta_based_overwrite) | `0` | Dev | 开发 |
| [seastore_default_max_object_size](#seastore_default_max_object_size) | `16777216` | Dev | 开发 |
| [seastore_device_size](#seastore_device_size) | `50_G` | Dev | 开发 |
| [seastore_disable_end_to_end_data_protection](#seastore_disable_end_to_end_data_protection) | `True` | Dev | 开发 |
| [seastore_full_integrity_check](#seastore_full_integrity_check) | `False` | Dev | 开发 |
| [seastore_hot_tier_generations](#seastore_hot_tier_generations) | `5` | Advanced | 性能 |
| [seastore_journal_batch_capacity](#seastore_journal_batch_capacity) | `16` | Dev | 开发 |
| [seastore_journal_batch_flush_size](#seastore_journal_batch_flush_size) | `16_M` | Dev | 开发 |
| [seastore_journal_batch_preferred_fullness](#seastore_journal_batch_preferred_fullness) | `0.95` | Dev | 开发 |
| [seastore_journal_iodepth_limit](#seastore_journal_iodepth_limit) | `5` | Dev | 开发 |
| [seastore_main_device_type](#seastore_main_device_type) | `SSD` | Dev | 开发 |
| [seastore_max_concurrent_transactions](#seastore_max_concurrent_transactions) | `128` | Advanced | 性能 |
| [seastore_max_data_allocation_size](#seastore_max_data_allocation_size) | `0` | Advanced | 性能 |
| [seastore_multiple_tiers_default_evict_ratio](#seastore_multiple_tiers_default_evict_ratio) | `0.6` | Advanced | 性能 |
| [seastore_multiple_tiers_fast_evict_ratio](#seastore_multiple_tiers_fast_evict_ratio) | `0.7` | Advanced | 性能 |
| [seastore_multiple_tiers_stop_evict_ratio](#seastore_multiple_tiers_stop_evict_ratio) | `0.5` | Advanced | 性能 |
| [seastore_require_partition_count_match_reactor_count](#seastore_require_partition_count_match_reactor_count) | `True` | Advanced | 性能 |
| [seastore_segment_cleaner_gc_autotune](#seastore_segment_cleaner_gc_autotune) | `True` | Advanced | 性能 |
| [seastore_segment_cleaner_gc_autotune_ratio](#seastore_segment_cleaner_gc_autotune_ratio) | `2.0` | Advanced | 性能 |
| [seastore_segment_cleaner_gc_formula](#seastore_segment_cleaner_gc_formula) | `cost_benefit` | Advanced | 性能 |
| [seastore_segment_size](#seastore_segment_size) | `64_M` | Advanced | 性能 |
...
**作用：** Override threshold for the gc auto-tune. The configured formula's pick is overridden with the greedy candidate when greedy's free fraction is at least this ratio times the formula's pick's free fraction. Higher is more conservative (override fires less often, the configured formula's age weighting is preserved more aggressively). Lower is more aggressive (override fires more often, behaviour converges toward pure greedy). The default (2.0) captures the random-write failure regime while staying clear of normal-operation fluctuations.
