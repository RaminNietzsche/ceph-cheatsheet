...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [bdev_aio](#bdev_aio) | `True` | Advanced | 性能 |
| [bdev_aio_max_queue_depth](#bdev_aio_max_queue_depth) | `1024` | Advanced | 性能 |
| [bdev_aio_poll_ms](#bdev_aio_poll_ms) | `250` | Advanced | 性能 |
| [bdev_aio_reap_max](#bdev_aio_reap_max) | `16` | Advanced | 性能 |
| [bdev_aio_submit_retry_initial_delay_us](#bdev_aio_submit_retry_initial_delay_us) | `125` | Advanced | 性能 |
| [bdev_aio_submit_retry_max](#bdev_aio_submit_retry_max) | `16` | Advanced | 性能 |
| [bdev_async_discard](#bdev_async_discard) | `False` | Advanced | 性能 |
| [bdev_async_discard_max_pending](#bdev_async_discard_max_pending) | `1000000` | Advanced | 性能 |
| [bdev_async_discard_threads](#bdev_async_discard_threads) | `0` | Advanced | 性能 |
| [bdev_block_size](#bdev_block_size) | `4_K` | Advanced | 性能 |
| [bdev_debug_aio](#bdev_debug_aio) | `False` | Dev | 开发 |
| [bdev_debug_aio_log_age](#bdev_debug_aio_log_age) | `5` | Dev | 开发 |
| [bdev_debug_aio_suicide_timeout](#bdev_debug_aio_suicide_timeout) | `1_min` | Dev | 开发 |
| [bdev_debug_discard_sleep](#bdev_debug_discard_sleep) | `0` | Dev | 开发 |
| [bdev_debug_inflight_ios](#bdev_debug_inflight_ios) | `False` | Dev | 开发 |
| [bdev_discard_max_bytes](#bdev_discard_max_bytes) | `10_G` | Advanced | 性能 |
| [bdev_enable_discard](#bdev_enable_discard) | `False` | Advanced | 策略 |
| [bdev_flock_retry](#bdev_flock_retry) | `3` | Advanced | 性能 |
| [bdev_flock_retry_interval](#bdev_flock_retry_interval) | `0.1` | Advanced | 性能 |
| [bdev_inject_crash](#bdev_inject_crash) | `0` | Dev | 开发 |
| [bdev_inject_crash_flush_delay](#bdev_inject_crash_flush_delay) | `2` | Dev | 开发 |
| [bdev_ioring](#bdev_ioring) | `False` | Advanced | 性能 |
| [bdev_ioring_hipri](#bdev_ioring_hipri) | `False` | Advanced | 性能 |
| [bdev_ioring_sqthread_poll](#bdev_ioring_sqthread_poll) | `False` | Advanced | 性能 |
| [bdev_max_discard_length](#bdev_max_discard_length) | `2147483648` | Advanced | 性能 |
| [bdev_nvme_unbind_from_kernel](#bdev_nvme_unbind_from_kernel) | `False` | Advanced | 性能 |
| [bdev_read_buffer_alignment](#bdev_read_buffer_alignment) | `4_K` | Advanced | 性能 |
| [bdev_read_preallocated_huge_buffers](#bdev_read_preallocated_huge_buffers) | `(empty)` | Advanced | 性能 |
| [bdev_stalled_read_warn_lifetime](#bdev_stalled_read_warn_lifetime) | `86400` | Advanced | 性能 |
| [bdev_stalled_read_warn_threshold](#bdev_stalled_read_warn_threshold) | `1` | Advanced | 性能 |
| [bdev_type](#bdev_type) | `(empty)` | Advanced | 性能 |
...
**作用：** maximum number of pending discards The maximum number of pending async discards that can be queued and not claimed by an async discard thread. Discards will not be issued once the queue is full and blocks will be freed back to the allocator immediately instead. This is useful if you have a device with slow discard performance that can't keep up to a consistently high write workload. 0 means 'unlimited'.
...
**作用：** times to retry the flock The number of times to retry on getting the block device lock. Programs such as systemd-udevd may compete with Ceph for this lock. 0 means 'unlimited'.
