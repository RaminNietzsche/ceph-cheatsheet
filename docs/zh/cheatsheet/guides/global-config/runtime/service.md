...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [service_unique_id](#service_unique_id) | `(empty)` | Advanced | 性能 |
...
| 表格 | [service.md#SP_service_unique_id](../../../config/global/service.md#SP_service_unique_id) |

**作用：** Unique string to be returned in PerfCounters
