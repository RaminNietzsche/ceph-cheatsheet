...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [mon_allow_pool_delete](#mon_allow_pool_delete) | `False` | Advanced | 策略 |
| [mon_client_bytes](#mon_client_bytes) | `100_M` | Advanced | 性能 |
| [mon_client_directed_command_retry](#mon_client_directed_command_retry) | `2` | Dev | 开发 |
| [mon_client_hunt_interval](#mon_client_hunt_interval) | `3` | Advanced | 性能 |
| [mon_client_hunt_interval_backoff](#mon_client_hunt_interval_backoff) | `1.5` | Advanced | 性能 |
| [mon_client_hunt_interval_max_multiple](#mon_client_hunt_interval_max_multiple) | `10` | Advanced | 性能 |
| [mon_client_hunt_interval_min_multiple](#mon_client_hunt_interval_min_multiple) | `1` | Advanced | 性能 |
| [mon_client_hunt_on_resend](#mon_client_hunt_on_resend) | `True` | Advanced | 性能 |
| [mon_client_hunt_parallel](#mon_client_hunt_parallel) | `3` | Advanced | 性能 |
| [mon_client_log_interval](#mon_client_log_interval) | `1` | Advanced | 性能 |
| [mon_client_max_log_entries_per_message](#mon_client_max_log_entries_per_message) | `1000` | Advanced | 性能 |
| [mon_client_ping_interval](#mon_client_ping_interval) | `10` | Advanced | 性能 |
| [mon_client_ping_timeout](#mon_client_ping_timeout) | `30` | Advanced | 性能 |
| [mon_client_target_rank](#mon_client_target_rank) | `-1` | Advanced | 性能 |
| [mon_config_key_max_entry_size](#mon_config_key_max_entry_size) | `64_K` | Advanced | 性能 |
| [mon_debug_block_osdmap_trim](#mon_debug_block_osdmap_trim) | `False` | Dev | 开发 |
| [mon_debug_deprecated_as_obsolete](#mon_debug_deprecated_as_obsolete) | `False` | Dev | 开发 |
| [mon_debug_dump_json](#mon_debug_dump_json) | `False` | Dev | 开发 |
| [mon_debug_dump_location](#mon_debug_dump_location) | `/var/log/ceph/$cluster-$name.tdump` | Dev | 开发 |
| [mon_debug_dump_transactions](#mon_debug_dump_transactions) | `False` | Dev | 开发 |
| [mon_debug_extra_checks](#mon_debug_extra_checks) | `False` | Dev | 开发 |
| [mon_debug_no_initial_persistent_features](#mon_debug_no_initial_persistent_features) | `False` | Dev | 开发 |
| [mon_debug_no_require_bluestore_for_ec_overwrites](#mon_debug_no_require_bluestore_for_ec_overwrites) | `False` | Dev | 开发 |
| [mon_debug_no_require_tentacle](#mon_debug_no_require_tentacle) | `False` | Dev | 开发 |
| [mon_debug_no_require_umbrella](#mon_debug_no_require_umbrella) | `False` | Dev | 开发 |
| [mon_debug_unsafe_allow_tier_with_nonempty_snaps](#mon_debug_unsafe_allow_tier_with_nonempty_snaps) | `False` | Dev | 开发 |
| [mon_dns_srv_name](#mon_dns_srv_name) | `ceph-mon` | Advanced | 性能 |
| [mon_fake_pool_delete](#mon_fake_pool_delete) | `False` | Advanced | 性能 |
| [mon_force_quorum_join](#mon_force_quorum_join) | `False` | Advanced | 性能 |
| [mon_globalid_prealloc](#mon_globalid_prealloc) | `10000` | Advanced | 性能 |
| [mon_host](#mon_host) | `(empty)` | Basic | 策略 |
| [mon_host_override](#mon_host_override) | `(empty)` | Advanced | 性能 |
| [mon_initial_members](#mon_initial_members) | `(empty)` | Advanced | 性能 |
| [mon_inject_pg_merge_bounce_probability](#mon_inject_pg_merge_bounce_probability) | `0` | Dev | 开发 |
| [mon_inject_sync_get_chunk_delay](#mon_inject_sync_get_chunk_delay) | `0` | Dev | 开发 |
| [mon_inject_transaction_delay_max](#mon_inject_transaction_delay_max) | `10` | Dev | 开发 |
| [mon_inject_transaction_delay_probability](#mon_inject_transaction_delay_probability) | `0` | Dev | 开发 |
| [mon_keyvaluedb](#mon_keyvaluedb) | `rocksdb` | Advanced | 性能 |
| [mon_max_log_epochs](#mon_max_log_epochs) | `500` | Advanced | 性能 |
| [mon_max_mdsmap_epochs](#mon_max_mdsmap_epochs) | `500` | Advanced | 性能 |
| [mon_max_mgrmap_epochs](#mon_max_mgrmap_epochs) | `500` | Advanced | 性能 |
| [mon_max_nvmeof_epochs](#mon_max_nvmeof_epochs) | `500` | Advanced | 性能 |
| [mon_max_osd](#mon_max_osd) | `10000` | Advanced | 性能 |
| [mon_max_pg_per_osd](#mon_max_pg_per_osd) | `500` | Advanced | 性能 |
| [mon_max_snap_prune_per_epoch](#mon_max_snap_prune_per_epoch) | `100` | Advanced | 性能 |
| [mon_min_osdmap_epochs](#mon_min_osdmap_epochs) | `500` | Advanced | 性能 |
| [mon_osd_backfillfull_ratio](#mon_osd_backfillfull_ratio) | `0.9` | Advanced | 性能 |
| [mon_osd_force_trim_to](#mon_osd_force_trim_to) | `0` | Dev | 开发 |
| [mon_osd_full_ratio](#mon_osd_full_ratio) | `0.95` | Advanced | 性能 |
| [mon_osd_initial_require_min_compat_client](#mon_osd_initial_require_min_compat_client) | `luminous` | Advanced | 性能 |
| [mon_osd_min_down_reporters](#mon_osd_min_down_reporters) | `2` | Advanced | 性能 |
| [mon_osd_nearfull_ratio](#mon_osd_nearfull_ratio) | `0.85` | Advanced | 性能 |
| [mon_osd_report_timeout](#mon_osd_report_timeout) | `15_min` | Advanced | 性能 |
| [mon_osd_reporter_subtree_level](#mon_osd_reporter_subtree_level) | `host` | Advanced | 性能 |
| [mon_osd_snap_trim_queue_warn_on](#mon_osd_snap_trim_queue_warn_on) | `32768` | Advanced | 性能 |
| [mon_probe_timeout](#mon_probe_timeout) | `2` | Advanced | 性能 |
| [mon_scrub_inject_crc_mismatch](#mon_scrub_inject_crc_mismatch) | `0` | Dev | 开发 |
| [mon_scrub_inject_missing_keys](#mon_scrub_inject_missing_keys) | `0` | Dev | 开发 |
| [mon_scrub_interval](#mon_scrub_interval) | `1_day` | Advanced | 性能 |
| [mon_scrub_max_keys](#mon_scrub_max_keys) | `100` | Advanced | 性能 |
| [mon_scrub_timeout](#mon_scrub_timeout) | `5_min` | Advanced | 性能 |
| [mon_sync_debug](#mon_sync_debug) | `False` | Dev | 开发 |
| [mon_sync_max_payload_keys](#mon_sync_max_payload_keys) | `2000` | Advanced | 性能 |
| [mon_sync_max_payload_size](#mon_sync_max_payload_size) | `1_M` | Advanced | 性能 |
| [mon_sync_provider_kill_at](#mon_sync_provider_kill_at) | `0` | Dev | 开发 |
| [mon_sync_requester_kill_at](#mon_sync_requester_kill_at) | `0` | Dev | 开发 |
| [mon_sync_timeout](#mon_sync_timeout) | `1_min` | Advanced | 性能 |
| [mon_warn_on_insecure_global_id_reclaim](#mon_warn_on_insecure_global_id_reclaim) | `True` | Advanced | 性能 |
| [mon_warn_on_insecure_global_id_reclaim_allowed](#mon_warn_on_insecure_global_id_reclaim_allowed) | `True` | Advanced | 策略 |
| [mon_warn_on_msgr2_not_enabled](#mon_warn_on_msgr2_not_enabled) | `True` | Advanced | 策略 |
| [mon_warn_on_slow_ping_ratio](#mon_warn_on_slow_ping_ratio) | `0.05` | Advanced | 性能 |
| [mon_warn_on_slow_ping_time](#mon_warn_on_slow_ping_time) | `0` | Advanced | 性能 |
| [mon_warn_pg_not_deep_scrubbed_ratio](#mon_warn_pg_not_deep_scrubbed_ratio) | `0.75` | Advanced | 性能 |
| [mon_warn_pg_not_scrubbed_ratio](#mon_warn_pg_not_scrubbed_ratio) | `0.5` | Advanced | 性能 |
