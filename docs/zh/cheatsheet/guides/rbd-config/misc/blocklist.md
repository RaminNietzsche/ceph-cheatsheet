...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [rbd_blocklist_expire_seconds](#rbd_blocklist_expire_seconds) | `0` | Advanced | 性能 |
| [rbd_blocklist_on_break_lock](#rbd_blocklist_on_break_lock) | `True` | Advanced | 性能 |
...
| 表格 | [rbd.md#SP_rbd_blocklist_expire_seconds](../../../config/rbd/rbd.md#SP_rbd_blocklist_expire_seconds) |

**作用：** number of seconds to blocklist - set to 0 for OSD default
...
| 表格 | [rbd.md#SP_rbd_blocklist_on_break_lock](../../../config/rbd/rbd.md#SP_rbd_blocklist_on_break_lock) |

**作用：** whether to blocklist clients whose lock was broken
