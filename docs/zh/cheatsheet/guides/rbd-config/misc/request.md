...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [rbd_request_timed_out_seconds](#rbd_request_timed_out_seconds) | `30` | Advanced | 性能 |
...
| 表格 | [rbd.md#SP_rbd_request_timed_out_seconds](../../../config/rbd/rbd.md#SP_rbd_request_timed_out_seconds) |

**作用：** number of seconds before maintenance request times out
