...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [rbd_auto_exclusive_lock_until_manual_request](#rbd_auto_exclusive_lock_until_manual_request) | `True` | Advanced | 性能 |
...
| 表格 | [rbd.md#SP_rbd_auto_exclusive_lock_until_manual_request](../../../config/rbd/rbd.md#SP_rbd_auto_exclusive_lock_until_manual_request) |

**作用：** automatically acquire/release exclusive lock until it is explicitly requested
