...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [rbd_balance_parent_reads](#rbd_balance_parent_reads) | `False` | Advanced | 性能 |
| [rbd_balance_snap_reads](#rbd_balance_snap_reads) | `False` | Advanced | 性能 |
...
| 表格 | [rbd.md#SP_rbd_balance_parent_reads](../../../config/rbd/rbd.md#SP_rbd_balance_parent_reads) |

**作用：** distribute parent read requests to random OSD
...
|---|---|
| 类型 | Bool · default `False` · **Advanced** |
| 表格 | [rbd.md#SP_rbd_balance_snap_reads](../../../config/rbd/rbd.md#SP_rbd_balance_snap_reads) |
