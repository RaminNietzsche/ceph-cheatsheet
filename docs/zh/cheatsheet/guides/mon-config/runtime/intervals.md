...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [mon_con_tracker_persist_interval](#mon_con_tracker_persist_interval) | `10` | Advanced | 性能 |
| [mon_elector_ping_timeout](#mon_elector_ping_timeout) | `2` | Advanced | 性能 |
| [mon_lease_ack_timeout_factor](#mon_lease_ack_timeout_factor) | `2` | Advanced | 性能 |
| [mon_lease_renew_interval_factor](#mon_lease_renew_interval_factor) | `0.6` | Advanced | 性能 |
| [mon_mds_blocklist_interval](#mon_mds_blocklist_interval) | `1_day` | Dev | 开发 |
| [mon_netsplit_grace_period](#mon_netsplit_grace_period) | `9` | Advanced | 性能 |
| [mon_nvmeofgw_failback_delay](#mon_nvmeofgw_failback_delay) | `0` | Advanced | 性能 |
| [mon_nvmeofgw_skip_failovers_interval](#mon_nvmeofgw_skip_failovers_interval) | `16` | Advanced | 性能 |
| [mon_session_timeout](#mon_session_timeout) | `5_min` | Advanced | 性能 |
| [mon_smart_report_timeout](#mon_smart_report_timeout) | `5` | Advanced | 性能 |
| [mon_subscribe_interval](#mon_subscribe_interval) | `1_day` | Dev | 开发 |
| [mon_tick_interval](#mon_tick_interval) | `5` | Advanced | 性能 |
| [mon_timecheck_interval](#mon_timecheck_interval) | `5_min` | Advanced | 性能 |
| [mon_timecheck_skew_interval](#mon_timecheck_skew_interval) | `30` | Advanced | 性能 |
| [mon_use_min_delay_socket](#mon_use_min_delay_socket) | `False` | Advanced | 性能 |
| [mon_warn_older_version_delay](#mon_warn_older_version_delay) | `7_day` | Advanced | 性能 |
| [nvmeof_mon_client_tick_period](#nvmeof_mon_client_tick_period) | `1` | Advanced | 性能 |
