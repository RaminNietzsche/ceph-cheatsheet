...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [mon_cluster_log_file](#mon_cluster_log_file) | `default=/var/log/ceph/$cluster.$channel.log cluster=/var/log/ceph/$cluster.log` | Advanced | 容量 |
| [mon_cluster_log_level](#mon_cluster_log_level) | `debug` | Advanced | 性能 |
| [mon_cluster_log_to_file](#mon_cluster_log_to_file) | `True` | Advanced | 容量 |
| [mon_cluster_log_to_graylog](#mon_cluster_log_to_graylog) | `false` | Advanced | 性能 |
| [mon_cluster_log_to_graylog_host](#mon_cluster_log_to_graylog_host) | `127.0.0.1` | Advanced | 性能 |
| [mon_cluster_log_to_graylog_port](#mon_cluster_log_to_graylog_port) | `12201` | Advanced | 性能 |
| [mon_cluster_log_to_journald](#mon_cluster_log_to_journald) | `false` | Advanced | 性能 |
| [mon_cluster_log_to_stderr](#mon_cluster_log_to_stderr) | `False` | Advanced | 性能 |
| [mon_cluster_log_to_syslog](#mon_cluster_log_to_syslog) | `default=false` | Advanced | 性能 |
| [mon_cluster_log_to_syslog_facility](#mon_cluster_log_to_syslog_facility) | `daemon` | Advanced | 性能 |
| [mon_health_detail_to_clog](#mon_health_detail_to_clog) | `True` | Dev | 开发 |
| [mon_health_log_update_period](#mon_health_log_update_period) | `5` | Dev | 开发 |
| [mon_health_to_clog](#mon_health_to_clog) | `True` | Advanced | 性能 |
| [mon_health_to_clog_interval](#mon_health_to_clog_interval) | `10_min` | Advanced | 性能 |
| [mon_health_to_clog_tick_interval](#mon_health_to_clog_tick_interval) | `1_min` | Dev | 开发 |
| [mon_log_full_interval](#mon_log_full_interval) | `50` | Advanced | 性能 |
| [mon_log_max](#mon_log_max) | `10000` | Advanced | 性能 |
| [mon_log_max_summary](#mon_log_max_summary) | `50` | Advanced | 性能 |
| [mon_max_log_entries_per_event](#mon_max_log_entries_per_event) | `4096` | Advanced | 性能 |
| [mon_op_log_threshold](#mon_op_log_threshold) | `5` | Advanced | 性能 |
