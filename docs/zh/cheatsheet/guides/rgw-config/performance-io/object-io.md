...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [rgw_get_obj_max_req_size](#rgw_get_obj_max_req_size) | `4_M` | Advanced | 策略 |
| [rgw_get_obj_window_size](#rgw_get_obj_window_size) | `16_M` | Advanced | 性能 |
| [rgw_put_obj_max_window_size](#rgw_put_obj_max_window_size) | `64_M` | Advanced | 性能 |
| [rgw_put_obj_min_window_size](#rgw_put_obj_min_window_size) | `16_M` | Advanced | 性能 |
