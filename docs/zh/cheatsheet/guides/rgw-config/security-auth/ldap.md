...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [rgw_ldap_binddn](#rgw_ldap_binddn) | `uid=admin,cn=users,dc=example,dc=com` | Advanced | 策略 |
| [rgw_ldap_dnattr](#rgw_ldap_dnattr) | `uid` | Advanced | 性能 |
| [rgw_ldap_searchdn](#rgw_ldap_searchdn) | `cn=users,cn=accounts,dc=example,dc=com` | Advanced | 性能 |
| [rgw_ldap_searchfilter](#rgw_ldap_searchfilter) | `(empty)` | Advanced | 性能 |
| [rgw_ldap_secret](#rgw_ldap_secret) | `/etc/openldap/secret` | Advanced | 策略 |
| [rgw_ldap_uri](#rgw_ldap_uri) | `(empty)` | Advanced | 连通性 |
