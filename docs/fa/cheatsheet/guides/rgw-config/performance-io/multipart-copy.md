...
|--------|---------|-------|--------|
| [rgw_copy_obj_progress](#rgw_copy_obj_progress) | `True` | Advanced | سیاست |
| [rgw_copy_obj_progress_every_bytes](#rgw_copy_obj_progress_every_bytes) | `1_M` | Advanced | عملکرد |
| [rgw_multipart_min_part_size](#rgw_multipart_min_part_size) | `5_M` | Advanced | عملکرد |
| [rgw_multipart_part_upload_limit](#rgw_multipart_part_upload_limit) | `10000` | Advanced | سیاست |
