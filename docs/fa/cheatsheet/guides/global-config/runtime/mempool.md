...
|--------|---------|-------|--------|
| [mempool_debug](#mempool_debug) | `False` | Dev | توسعه |
...
| جدول | [mempool.md#SP_mempool_debug](../../../config/global/mempool.md#SP_mempool_debug) |
...
```bash
ceph config set global mempool_debug true
ceph config get global mempool_debug
```
