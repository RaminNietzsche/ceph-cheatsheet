...
|--------|---------|-------|--------|
| [objectstore_blackhole](#objectstore_blackhole) | `False` | Advanced | عملکرد |
| [objectstore_debug_throw_on_failed_txc](#objectstore_debug_throw_on_failed_txc) | `False` | Dev | توسعه |
