...
|--------|---------|-------|--------|
| [inject_early_sigterm](#inject_early_sigterm) | `False` | Dev | توسعه |
...
| جدول | [inject.md#SP_inject_early_sigterm](../../../config/global/inject.md#SP_inject_early_sigterm) |

**کارکرد:** send ourselves a SIGTERM early during startup
