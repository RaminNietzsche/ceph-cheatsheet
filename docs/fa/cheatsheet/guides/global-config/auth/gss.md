...
**کارکرد:** GSS/KRB5 Keytab file for client authentication This sets the full path for the GSS/Kerberos client keytab file location.
...
**کارکرد:** This sets the GSS target service name.
