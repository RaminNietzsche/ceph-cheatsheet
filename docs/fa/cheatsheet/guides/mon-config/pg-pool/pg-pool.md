...
**کارکرد:** the amount of data (in bytes) in a data chunk, per stripe A value of 0 causes the code to select either a 4KB or 16KB stripe_unit depending on whether allow_ec_optimizations is enabled.
