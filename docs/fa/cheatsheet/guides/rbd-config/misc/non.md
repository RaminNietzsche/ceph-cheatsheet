...
|--------|---------|-------|--------|
| [rbd_non_blocking_aio](#rbd_non_blocking_aio) | `True` | Advanced | عملکرد |
...
| جدول | [rbd.md#SP_rbd_non_blocking_aio](../../../config/rbd/rbd.md#SP_rbd_non_blocking_aio) |

**کارکرد:** process AIO ops from a dispatch thread to prevent blocking
