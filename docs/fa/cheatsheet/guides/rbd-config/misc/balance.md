...
|--------|---------|-------|--------|
| [rbd_balance_parent_reads](#rbd_balance_parent_reads) | `False` | Advanced | عملکرد |
| [rbd_balance_snap_reads](#rbd_balance_snap_reads) | `False` | Advanced | عملکرد |
...
| جدول | [rbd.md#SP_rbd_balance_parent_reads](../../../config/rbd/rbd.md#SP_rbd_balance_parent_reads) |

**کارکرد:** distribute parent read requests to random OSD
...
|---|---|
| نوع | Bool · default `False` · **Advanced** |
| جدول | [rbd.md#SP_rbd_balance_snap_reads](../../../config/rbd/rbd.md#SP_rbd_balance_snap_reads) |
