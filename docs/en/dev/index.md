...
<nav class="hub-nav">
  <div class="hub-nav__inner">
    ...
    <div class="hub-nav__actions">
      <a href="/en/" class="hub-nav__hub-link" title="Ceph Docs Hub"><i class="fas fa-home"></i> Hub</a>
      ...
      <a href="/en/arch/rgw/learning-program/" class="hub-nav__cta"><i class="fas fa-graduation-cap"></i> Start learning</a>
    </div>
  </div>
</nav>
...
<footer class="hub-footer hub-footer--section">
  <div class="hub-footer__inner">
    <div>
      ...
      <p class="hub-footer__note">Independent developer portal · <a href="/en/">Ceph Docs Hub</a></p>
    </div>
