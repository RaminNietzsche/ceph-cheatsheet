...
| <span id="SP_rbd_balance_parent_reads">rbd_balance_parent_reads</span> |  distribute parent read requests to random OSD | Advanced | Bool | False |  |  |  |  |  | [[rbd_read_from_replica_policy](~/config/rbd/rbd#SP_rbd_read_from_replica_policy)] |  | rbd |  |  |  |
| <span id="SP_rbd_balance_snap_reads">rbd_balance_snap_reads</span> |  distribute snap read requests to random OSD | Advanced | Bool | False |  |  |  |  |  | [[rbd_read_from_replica_policy](~/config/rbd/rbd#SP_rbd_read_from_replica_policy)] |  | rbd |  |  |  |
...
| <span id="SP_rbd_localize_parent_reads">rbd_localize_parent_reads</span> |  localize parent requests to closest OSD | Advanced | Bool | False |  |  |  |  |  | [[rbd_read_from_replica_policy](~/config/rbd/rbd#SP_rbd_read_from_replica_policy)] |  | rbd |  |  |  |
| <span id="SP_rbd_localize_snap_reads">rbd_localize_snap_reads</span> |  localize snap read requests to closest OSD | Advanced | Bool | False |  |  |  |  |  | [[rbd_read_from_replica_policy](~/config/rbd/rbd#SP_rbd_read_from_replica_policy)] |  | rbd |  |  |  |
