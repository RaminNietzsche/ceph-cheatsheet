...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| <span id="SP_debug_asok_assert_abort">debug_asok_assert_abort</span> |  Enable the admin socket commands 'assert' and 'abort' testing crash dumps etc. | Dev | Bool | False |  |  |  |  |  |  |  |  |  |  |  |
| <span id="SP_debug_asserts_on_shutdown">debug_asserts_on_shutdown</span> |  Enable certain assertions to check for refcounting bugs on shutdown; see http://tracker.ceph.com/issues/21738 | Dev | Bool | False |  |  |  |  |  |  |  |  |  |  |  |
