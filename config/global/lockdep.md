...
| <span id="SP_lockdep_force_backtrace">lockdep_force_backtrace</span> |  always gather current backtrace at every lock | Dev | Bool | False |  |  |  |  |  | [[lockdep](~/config/global/lockdep#SP_lockdep)] | STARTUP | common |  |  |  |
