...
| <span id="SP_ms_bind_ipv4">ms_bind_ipv4</span> |  Bind servers to IPv4 address(es) | Advanced | Bool | True |  |  |  |  |  | [[ms_bind_ipv6](/config/global/ms.md#SP_ms_bind_ipv6)] |  |  |  |  |  |
| <span id="SP_ms_bind_ipv6">ms_bind_ipv6</span> |  Bind servers to IPv6 address(es) | Advanced | Bool | False |  |  |  |  |  | [[ms_bind_ipv4](/config/global/ms.md#SP_ms_bind_ipv4)] |  |  |  |  |  |
| <span id="SP_ms_bind_msgr1">ms_bind_msgr1</span> |  Bind servers to msgr1 (legacy) protocol address(es) | Advanced | Bool | True |  |  |  |  |  | [[ms_bind_msgr2](/config/global/ms.md#SP_ms_bind_msgr2)] |  |  |  |  |  |
| <span id="SP_ms_bind_msgr2">ms_bind_msgr2</span> |  Bind servers to msgr2 (nautilus+) protocol address(es) | Advanced | Bool | True |  |  |  |  |  | [[ms_bind_msgr1](/config/global/ms.md#SP_ms_bind_msgr1)] |  |  |  |  |  |
...
| <span id="SP_ms_client_mode">ms_client_mode</span> |  Connection modes (crc, secure) for connections from clients in order of preference | Basic | Str | crc secure |  |  |  |  |  | [[ms_cluster_mode](/config/global/ms.md#SP_ms_cluster_mode), [ms_service_mode](/config/global/ms.md#SP_ms_service_mode)] | STARTUP |  |  |  |  |
...
| <span id="SP_ms_cluster_mode">ms_cluster_mode</span> |  Connection modes (crc, secure) for intra-cluster connections in order of preference | Basic | Str | crc secure |  |  |  |  |  | [[ms_service_mode](/config/global/ms.md#SP_ms_service_mode), [ms_client_mode](/config/global/ms.md#SP_ms_client_mode)] | STARTUP |  |  |  |  |
| <span id="SP_ms_cluster_type">ms_cluster_type</span> |  Messenger implementation to use for the internal cluster network | Advanced | Str |  |  |  |  |  |  | [[ms_type](/config/global/ms.md#SP_ms_type)] | STARTUP |  |  |  If not specified, use ms_type |  |
...
| <span id="SP_ms_osd_compression_algorithm">ms_osd_compression_algorithm</span> |  Compression algorithm to use in Messenger when communicating with OSD | Advanced | Str | snappy |  |  |  |  |  | [[ms_osd_compress_mode](/config/global/ms.md#SP_ms_osd_compress_mode)] | RUNTIME | osd |  |  Compression algorithm for connections with OSD in order of preference Although the default value is set to snappy, a list (like snappy zlib zstd etc.) is acceptable as well. |  |
