...
| <span id="SP_ms_bind_ipv4">ms_bind_ipv4</span> |  Bind servers to IPv4 address(es) | Advanced | Bool | True |  |  |  |  |  | [[ms_bind_ipv6](#SP_ms_bind_ipv6)] |  |  |  |  |  |
| <span id="SP_ms_bind_ipv6">ms_bind_ipv6</span> |  Bind servers to IPv6 address(es) | Advanced | Bool | False |  |  |  |  |  | [[ms_bind_ipv4](#SP_ms_bind_ipv4)] |  |  |  |  |  |
| <span id="SP_ms_bind_msgr1">ms_bind_msgr1</span> |  Bind servers to msgr1 (legacy) protocol address(es) | Advanced | Bool | True |  |  |  |  |  | [[ms_bind_msgr2](#SP_ms_bind_msgr2)] |  |  |  |  |  |
| <span id="SP_ms_bind_msgr2">ms_bind_msgr2</span> |  Bind servers to msgr2 (nautilus+) protocol address(es) | Advanced | Bool | True |  |  |  |  |  | [[ms_bind_msgr1](#SP_ms_bind_msgr1)] |  |  |  |  |  |
...
| <span id="SP_ms_bind_retry_count">ms_bind_retry_count</span> |  Number of attempts to make while bind(2)ing to a port | Advanced | Int | 0 |  |  |  |  |  |  |  |  |  |  |  |
| <span id="SP_ms_bind_retry_delay">ms_bind_retry_delay</span> |  Delay between bind(2) attempts (seconds) | Advanced | Int | 0 |  |  |  |  |  |  |  |  |  |  |  |
...
| <span id="SP_ms_client_mode">ms_client_mode</span> |  Connection modes (crc, secure) for connections from clients in order of preference | Basic | Str | crc secure |  |  |  |  |  | [[ms_cluster_mode](#SP_ms_cluster_mode), [ms_service_mode](#SP_ms_service_mode)] | STARTUP |  |  |  |  |
| <span id="SP_ms_client_throttle_retry_time_interval">ms_client_throttle_retry_time_interval</span> |  In microseconds, user client, the time interval between the next retry when the throttle get_or_fail. | Dev | Uint | 5000 |  | 1000 | 60000000 |  |  |  |  |  |  |  |  |
| <span id="SP_ms_cluster_mode">ms_cluster_mode</span> |  Connection modes (crc, secure) for intra-cluster connections in order of preference | Basic | Str | crc secure |  |  |  |  |  | [[ms_service_mode](#SP_ms_service_mode), [ms_client_mode](#SP_ms_client_mode)] | STARTUP |  |  |  |  |
| <span id="SP_ms_cluster_type">ms_cluster_type</span> |  Messenger implementation to use for the internal cluster network | Advanced | Str |  |  |  |  |  |  | [[ms_type](#SP_ms_type)] | STARTUP |  |  |  If not specified, use ms_type |  |
...
| <span id="SP_ms_dpdk_coremask">ms_dpdk_coremask</span> |  | Advanced | Str | 0xF |  |  |  |  |  | [[ms_async_op_threads](#SP_ms_async_op_threads)] |  |  |  |  |  |
...
| <span id="SP_ms_max_backoff">ms_max_backoff</span> |  Maximum backoff after a network error before retrying (seconds) | Advanced | Float | 15 |  |  |  |  |  | [[ms_initial_backoff](#SP_ms_initial_backoff)] |  |  |  |  |  |
| <span id="SP_ms_mon_client_mode">ms_mon_client_mode</span> |  Connection modes (crc, secure) for connections from clients to monitors in order of preference | Basic | Str | secure crc |  |  |  |  |  | [[ms_mon_service_mode](#SP_ms_mon_service_mode), [ms_mon_cluster_mode](#SP_ms_mon_cluster_mode), [ms_service_mode](#SP_ms_service_mode), [ms_cluster_mode](#SP_ms_cluster_mode), [ms_client_mode](#SP_ms_client_mode)] | STARTUP |  |  |  |  |
| <span id="SP_ms_mon_cluster_mode">ms_mon_cluster_mode</span> |  Connection modes (crc, secure) for intra-mon connections in order of preference | Basic | Str | secure crc |  |  |  |  |  | [[ms_mon_service_mode](#SP_ms_mon_service_mode), [ms_mon_client_mode](#SP_ms_mon_client_mode), [ms_service_mode](#SP_ms_service_mode), [ms_cluster_mode](#SP_ms_cluster_mode), [ms_client_mode](#SP_ms_client_mode)] | STARTUP |  |  |  |  |
| <span id="SP_ms_mon_service_mode">ms_mon_service_mode</span> |  Allowed connection modes (crc, secure) for connections to mons | Basic | Str | secure crc |  |  |  |  |  | [[ms_service_mode](#SP_ms_service_mode), [ms_mon_cluster_mode](#SP_ms_mon_cluster_mode), [ms_mon_client_mode](#SP_ms_mon_client_mode), [ms_cluster_mode](#SP_ms_cluster_mode), [ms_client_mode](#SP_ms_client_mode)] | STARTUP |  |  |  |  |
| <span id="SP_ms_osd_compress_min_size">ms_osd_compress_min_size</span> |  Minimal message size eligable for on-wire compression | Advanced | Uint | 1_K |  |  |  |  |  | [[ms_osd_compress_mode](#SP_ms_osd_compress_mode)] | RUNTIME | osd |  |  |  |
| <span id="SP_ms_osd_compress_mode">ms_osd_compress_mode</span> |  Compression policy to use in Messenger for communicating with OSD | Advanced | Str | none |  |  |  | ["none", "force"] |  | [[ms_compress_secure](#SP_ms_compress_secure)] | RUNTIME | osd |  |  |  |
| <span id="SP_ms_osd_compression_algorithm">ms_osd_compression_algorithm</span> |  Compression algorithm to use in Messenger when communicating with OSD | Advanced | Str | snappy |  |  |  |  |  | [[ms_osd_compress_mode](#SP_ms_osd_compress_mode)] | RUNTIME | osd |  |  Compression algorithm for connections with OSD in order of preference Although the default value is set to snappy, a list (like snappy zlib zstd etc.) is acceptable as well. |  |
...
| <span id="SP_ms_public_type">ms_public_type</span> |  Messenger implementation to use for the public network | Advanced | Str |  |  |  |  |  |  | [[ms_type](#SP_ms_type)] | STARTUP |  |  |  If not specified, use ms_type |  |
| <span id="SP_ms_service_mode">ms_service_mode</span> |  Allowed connection modes (crc, secure) for connections to daemons | Basic | Str | crc secure |  |  |  |  |  | [[ms_cluster_mode](#SP_ms_cluster_mode), [ms_client_mode](#SP_ms_client_mode)] | STARTUP |  |  |  |  |
...
| <span id="SP_ms_tcp_prefetch_max_size">ms_tcp_prefetch_max_size</span> |  Maximum amount of data to prefetch out of the socket receive buffer | Advanced | Size | 64_K |  |  |  |  |  |  |  |  |  |  |  |
| <span id="SP_ms_tcp_rcvbuf">ms_tcp_rcvbuf</span> |  Size of TCP socket receive buffer | Advanced | Size | 0 |  |  |  |  |  |  |  |  |  |  |  |
| <span id="SP_ms_time_events_min_wait_interval">ms_time_events_min_wait_interval</span> |  In microseconds, msgr-worker's time_events min wait time for epoll_wait timeout | Dev | Uint | 1000 |  | 0 | 60000000 |  |  |  |  |  |  |  |  |
