...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| <span id="SP_run_dir">run_dir</span> |  Path for the 'run' directory for storing pid and socket files | <span class="badge badge-level-advanced">Advanced</span> | Str | /var/run/ceph |  |  |  |  |  | [[admin_socket](admin.md#SP_admin_socket)] | STARTUP | common |  |  |  |
