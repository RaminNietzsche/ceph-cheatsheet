...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| <span id="SP_perf">perf</span> |  Enable internal performance metrics | <span class="badge badge-level-advanced">Advanced</span> | Bool | True |  |  |  |  |  |  |  |  |  |  If enabled, collect and expose internal health metrics |  |
