...
| <span id="SP_admin_socket_mode">admin_socket_mode</span> |  File mode to set for the admin socket, e.g, '0755' | Advanced | Str |  |  |  |  |  |  | [[admin_socket](/config/global/admin.md#SP_admin_socket)] | STARTUP | common |  |  |  |
