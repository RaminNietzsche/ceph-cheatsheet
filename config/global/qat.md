...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| <span id="SP_qat_compressor_busy_polling">qat_compressor_busy_polling</span> |  Set QAT busy bolling to reduce latency at the cost of potentially increasing CPU usage | Advanced | Bool | False |  |  |  |  |  |  |  |  |  |  |  |
