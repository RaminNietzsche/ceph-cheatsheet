...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [librados_thread_count](#librados_thread_count) | `2` | Advanced | 性能 |
...
| 表格 | [librados.md#SP_librados_thread_count](../../../config/global/librados.md#SP_librados_thread_count) |

**作用：** Size of thread pool for Objecter
