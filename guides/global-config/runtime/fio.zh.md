...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [fio_dir](#fio_dir) | `/tmp/fio` | Advanced | 容量 |
...
| | |
|---|---|
| 类型 | Str · default `/tmp/fio` · **Advanced** |
| 表格 | [fio.md#SP_fio_dir](../../../config/global/fio.md#SP_fio_dir) |

**作用：** FIO data directory for FIO-objectstore
