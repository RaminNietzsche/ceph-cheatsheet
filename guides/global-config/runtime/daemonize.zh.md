...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [daemonize](#daemonize) | `True` | Advanced | 性能 |
...
| 表格 | [daemonize.md#SP_daemonize](../../../config/global/daemonize.md#SP_daemonize) |

**作用：** Whether to daemonize (background) after startup
