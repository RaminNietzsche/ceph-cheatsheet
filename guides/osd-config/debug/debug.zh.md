...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [osd_debug_feed_pullee](#osd_debug_feed_pullee) | `-1` | Dev | 开发 |
| [osd_debug_trim_objects](#osd_debug_trim_objects) | `False` | Advanced | 性能 |
| [osd_inject_bad_map_crc_probability](#osd_inject_bad_map_crc_probability) | `0` | Dev | 开发 |
| [osd_inject_failure_on_pg_removal](#osd_inject_failure_on_pg_removal) | `False` | Dev | 开发 |
