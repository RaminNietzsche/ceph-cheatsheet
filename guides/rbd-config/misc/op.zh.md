...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [rbd_op_thread_timeout](#rbd_op_thread_timeout) | `60` | Advanced | 性能 |
| [rbd_op_threads](#rbd_op_threads) | `1` | Advanced | 性能 |
...
| 表格 | [rbd.md#SP_rbd_op_thread_timeout](../../../config/rbd/rbd.md#SP_rbd_op_thread_timeout) |

**作用：** time in seconds for detecting a hung thread
...
| 表格 | [rbd.md#SP_rbd_op_threads](../../../config/rbd/rbd.md#SP_rbd_op_threads) |

**作用：** number of threads to utilize for internal processing
