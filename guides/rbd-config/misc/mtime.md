...
|--------|---------|-------|--------|
| [rbd_mtime_update_interval](#rbd_mtime_update_interval) | `60` | Advanced | Performance |
...
| Table | [rbd.md#SP_rbd_mtime_update_interval](../../../config/rbd/rbd.md#SP_rbd_mtime_update_interval) |

**What it does:** RBD Image modify timestamp refresh interval. Set to 0 to disable modify timestamp update.
