...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [rbd_skip_partial_discard](#rbd_skip_partial_discard) | `True` | Advanced | 性能 |
...
| 表格 | [rbd.md#SP_rbd_skip_partial_discard](../../../config/rbd/rbd.md#SP_rbd_skip_partial_discard) |

**作用：** skip discard (zero) of unaligned extents within an object
