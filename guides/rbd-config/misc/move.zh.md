...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [rbd_move_parent_to_trash_on_remove](#rbd_move_parent_to_trash_on_remove) | `False` | Basic | 策略 |
| [rbd_move_to_trash_on_remove](#rbd_move_to_trash_on_remove) | `False` | Basic | 策略 |
| [rbd_move_to_trash_on_remove_expire_seconds](#rbd_move_to_trash_on_remove_expire_seconds) | `0` | Basic | 策略 |
