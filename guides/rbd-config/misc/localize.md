...
| Table | [rbd.md#SP_rbd_localize_parent_reads](../../../config/rbd/rbd.md#SP_rbd_localize_parent_reads) |

**What it does:** localize parent requests to closest OSD
...
|---|---|
| Type | Bool · default `False` · **Advanced** |
| Table | [rbd.md#SP_rbd_localize_snap_reads](../../../config/rbd/rbd.md#SP_rbd_localize_snap_reads) |

**What it does:** localize snap read requests to closest OSD
