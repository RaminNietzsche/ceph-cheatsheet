...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [rbd_clone_copy_on_read](#rbd_clone_copy_on_read) | `False` | Advanced | 性能 |
...
| 表格 | [rbd.md#SP_rbd_clone_copy_on_read](../../../config/rbd/rbd.md#SP_rbd_clone_copy_on_read) |

**作用：** copy-up parent image blocks to clone upon read request
