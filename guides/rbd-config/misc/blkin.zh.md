...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [rbd_blkin_trace_all](#rbd_blkin_trace_all) | `False` | Advanced | 性能 |
...
| 表格 | [rbd.md#SP_rbd_blkin_trace_all](../../../config/rbd/rbd.md#SP_rbd_blkin_trace_all) |

**作用：** create a blkin trace for all RBD requests
