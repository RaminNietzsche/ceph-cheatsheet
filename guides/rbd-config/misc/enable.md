...
| Table | [rbd.md#SP_rbd_enable_alloc_hint](../../../config/rbd/rbd.md#SP_rbd_enable_alloc_hint) |

**What it does:** when writing a object, it will issue a hint to osd backend to indicate the expected size object need
