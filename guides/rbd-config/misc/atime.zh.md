...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [rbd_atime_update_interval](#rbd_atime_update_interval) | `60` | Advanced | 性能 |
...
| 表格 | [rbd.md#SP_rbd_atime_update_interval](../../../config/rbd/rbd.md#SP_rbd_atime_update_interval) |

**作用：** RBD Image access timestamp refresh interval. Set to 0 to disable access timestamp update.
