...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [rbd_non_blocking_aio](#rbd_non_blocking_aio) | `True` | Advanced | 性能 |
...
| 表格 | [rbd.md#SP_rbd_non_blocking_aio](../../../config/rbd/rbd.md#SP_rbd_non_blocking_aio) |

**作用：** process AIO ops from a dispatch thread to prevent blocking
