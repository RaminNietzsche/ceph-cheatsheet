...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [rbd_readahead_disable_after_bytes](#rbd_readahead_disable_after_bytes) | `50_M` | Advanced | 性能 |
| [rbd_readahead_max_bytes](#rbd_readahead_max_bytes) | `512_K` | Advanced | 性能 |
| [rbd_readahead_trigger_requests](#rbd_readahead_trigger_requests) | `10` | Advanced | 性能 |
