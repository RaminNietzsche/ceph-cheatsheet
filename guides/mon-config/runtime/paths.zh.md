...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [mon_data](#mon_data) | `/var/lib/ceph/mon/$cluster-$id` | Advanced | 性能 |
| [mon_data_avail_crit](#mon_data_avail_crit) | `5` | Advanced | 性能 |
| [mon_data_avail_warn](#mon_data_avail_warn) | `30` | Advanced | 性能 |
| [mon_data_size_warn](#mon_data_size_warn) | `15_G` | Advanced | 性能 |
