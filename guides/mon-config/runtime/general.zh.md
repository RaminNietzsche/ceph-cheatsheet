...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [enable_availability_tracking](#enable_availability_tracking) | `False` | Advanced | 策略 |
| [mon_clock_drift_allowed](#mon_clock_drift_allowed) | `0.05` | Advanced | 性能 |
| [mon_clock_drift_warn_backoff](#mon_clock_drift_warn_backoff) | `5` | Advanced | 性能 |
| [mon_compact_on_bootstrap](#mon_compact_on_bootstrap) | `False` | Advanced | 性能 |
| [mon_compact_on_start](#mon_compact_on_start) | `False` | Advanced | 性能 |
| [mon_compact_on_trim](#mon_compact_on_trim) | `True` | Advanced | 性能 |
| [mon_con_tracker_score_halflife](#mon_con_tracker_score_halflife) | `43200` | Advanced | 性能 |
| [mon_cpu_threads](#mon_cpu_threads) | `4` | Advanced | 性能 |
| [mon_crush_min_required_version](#mon_crush_min_required_version) | `hammer` | Advanced | 性能 |
| [mon_daemon_bytes](#mon_daemon_bytes) | `400_M` | Advanced | 性能 |
| [mon_down_added_grace](#mon_down_added_grace) | `3_min` | Advanced | 性能 |
| [mon_down_mkfs_grace](#mon_down_mkfs_grace) | `1_min` | Advanced | 性能 |
| [mon_down_uptime_grace](#mon_down_uptime_grace) | `1_min` | Advanced | 性能 |
| [mon_elector_ignore_propose_margin](#mon_elector_ignore_propose_margin) | `0.0005` | Advanced | 性能 |
| [mon_elector_ping_divisor](#mon_elector_ping_divisor) | `2` | Advanced | 性能 |
| [mon_enable_op_tracker](#mon_enable_op_tracker) | `True` | Advanced | 策略 |
| [mon_fsmap_prune_threshold](#mon_fsmap_prune_threshold) | `300` | Advanced | 性能 |
| [mon_health_max_detail](#mon_health_max_detail) | `50` | Advanced | 性能 |
| [mon_lease](#mon_lease) | `5` | Advanced | 性能 |
| [mon_mds_force_trim_to](#mon_mds_force_trim_to) | `0` | Dev | 开发 |
| [mon_mds_skip_sanity](#mon_mds_skip_sanity) | `False` | Advanced | 性能 |
| [mon_memory_autotune](#mon_memory_autotune) | `True` | Basic | 策略 |
| [mon_memory_target](#mon_memory_target) | `2_G` | Basic | 策略 |
| [mon_nvmeofgw_beacon_grace](#mon_nvmeofgw_beacon_grace) | `7` | Advanced | 性能 |
| [mon_nvmeofgw_beacons_till_ack](#mon_nvmeofgw_beacons_till_ack) | `15` | Advanced | 性能 |
| [mon_nvmeofgw_delete_grace](#mon_nvmeofgw_delete_grace) | `15_min` | Advanced | 性能 |
| [mon_nvmeofgw_set_group_id_retry](#mon_nvmeofgw_set_group_id_retry) | `1000` | Advanced | 性能 |
| [mon_nvmeofgw_wrong_map_ignore_sec](#mon_nvmeofgw_wrong_map_ignore_sec) | `15` | Advanced | 性能 |
| [mon_op_complaint_time](#mon_op_complaint_time) | `30` | Advanced | 性能 |
| [mon_op_history_duration](#mon_op_history_duration) | `10_min` | Advanced | 性能 |
| [mon_op_history_size](#mon_op_history_size) | `20` | Advanced | 性能 |
| [mon_op_history_slow_op_size](#mon_op_history_slow_op_size) | `20` | Advanced | 性能 |
| [mon_op_history_slow_op_threshold](#mon_op_history_slow_op_threshold) | `10` | Advanced | 性能 |
| [mon_rocksdb_options](#mon_rocksdb_options) | `write_buffer_size=33554432,compression=kNoCompression,level_compaction_dynamic_level_bytes=true` | Advanced | 性能 |
| [mon_stretch_cluster_recovery_ratio](#mon_stretch_cluster_recovery_ratio) | `0.6` | Advanced | 性能 |
| [mon_stretch_max_bucket_weight_delta](#mon_stretch_max_bucket_weight_delta) | `0.1` | Dev | 开发 |
| [mon_stretch_recovery_min_wait](#mon_stretch_recovery_min_wait) | `15` | Advanced | 性能 |
| [mon_warn_on_colocated_monitors](#mon_warn_on_colocated_monitors) | `False` | Advanced | 性能 |
| [mon_warn_on_crush_straw_calc_version_zero](#mon_warn_on_crush_straw_calc_version_zero) | `True` | Advanced | 性能 |
| [mon_warn_on_degraded_stretch_mode](#mon_warn_on_degraded_stretch_mode) | `True` | Advanced | 性能 |
| [mon_warn_on_legacy_crush_tunables](#mon_warn_on_legacy_crush_tunables) | `True` | Advanced | 性能 |
| [mon_warn_on_older_version](#mon_warn_on_older_version) | `True` | Advanced | 性能 |
| [nvmeof_mon_client_connect_panic](#nvmeof_mon_client_connect_panic) | `30` | Advanced | 性能 |
| [nvmeof_mon_client_disconnect_panic](#nvmeof_mon_client_disconnect_panic) | `100` | Advanced | 性能 |
