...
| 选项 | 默认值 | 级别 | 调优 |
|--------|---------|-------|--------|
| [rgw_gcors_allow_headers](#rgw_gcors_allow_headers) | `(empty)` | Advanced | 性能 |
| [rgw_gcors_allow_methods](#rgw_gcors_allow_methods) | `(empty)` | Advanced | 性能 |
| [rgw_gcors_allow_origins](#rgw_gcors_allow_origins) | `(empty)` | Advanced | 性能 |
| [rgw_gcors_expose_headers](#rgw_gcors_expose_headers) | `(empty)` | Advanced | 性能 |
